...
export function LandingPageHome() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
        {teas.map((tea, index) => (
          <motion.div
            ...
            className="bg-white/10 backdrop-blur-md p-5 rounded-xl shadow-lg w-64 text-center"
          >
      ...
      <div className="mt-16 text-center">
        ...
        <div className=" grid grid-cols-2 md:grid-cols-4 gap-6 mt-6">
          {brewingSteps.map((step, index) => (
            ...
            >
              <img src={step.icon} alt={step.title} className="w-full aspect-[2/3] overflow-hidden cursor-pointer rounded-lg mb-3 transition-transform duration-300 hover:scale-105 " />
        ...
        <div className="flex gap-6 mt-6 overflow-auto">
          {testimonials.map((review, index) => (
            <motion.div
              ...
              transition={{ delay: index * 0.2 }}
              className=" p-5 bg-white backdrop-blur-lg rounded-lg shadow-lg w-80"
            >
      ...
      {/* Subscription Box */}
      <div className="mt-16 text-center bg-white/10 backdrop-blur-md p-10 rounded-lg">
      ...
      {/* Special Offer */}
      <div className="mt-16 text-center bg-white/10 backdrop-blur-md p-6 rounded-lg">
        <h2 className="text-3xl font-semibold text-[#4B382A]">Limited-Time Offer! 🎉</h2>
        <p className="text-lg text-[#4B382A] mt-3">Get 20% off on your monthly chai primium!</p>
        <button className="button1 mt-5 ">
          Claim Now
        </button>
      </div>
